	...
	public function valoracion_DL()
		{
			...
			$Juana = $this->modelo_inicio->valoracion_juana();
			$Jose2 = $this->modelo_inicio->valoracion_jose3();
			$Sandra = $this->modelo_inicio->valoracion_sandra();
			$Octavio = $this->modelo_inicio->valoracion_octavio();
			$Francisco = $this->modelo_inicio->valoracion_francisco();
			$Alfredo = $this->modelo_inicio->valoracion_alfredo();
			$Meyly = $this->modelo_inicio->valoracion_meyly();
			$Hector = $this->modelo_inicio->valoracion_hector();
			$Rosalina = $this->modelo_inicio->valoracion_rosalina();
			$Juan = $this->modelo_inicio->valoracion_juan();
			$Miguel = $this->modelo_inicio->valoracion_miguel();
			$Armida = $this->modelo_inicio->valoracion_armida();
			$Sergio = $this->modelo_inicio->valoracion_sergio();
			$Santiago = $this->modelo_inicio->valoracion_santiago();
			...
			$datos = array(
						  ...
						  'JuanaP' => $Juana['positivos'],
						  'JuanaNe' => $Juana['negativos'],
						  'JuanaN' => $Juana['neutros'],							  
						  'Jose2P' => $Jose2['positivos'],
						  'Jose2Ne' => $Jose2['negativos'],
						  'Jose2N' => $Jose2['neutros'],	
						  'SandraP' => $Sandra['positivos'],
						  'SandraNe' => $Sandra['negativos'],
						  'SandraN' => $Sandra['neutros'],	
						  'OctavioP' => $Octavio['positivos'],
						  'OctavioNe' => $Octavio['negativos'],
						  'OctavioN' => $Octavio['neutros'],	
						  'FranciscoP' => $Francisco['positivos'],
						  'FranciscoNe' => $Francisco['negativos'],
						  'FranciscoN' => $Francisco['neutros'],	
						  'AlfredoP' => $Alfredo['positivos'],
						  'AlfredoNe' => $Alfredo['negativos'],
						  'AlfredoN' => $Alfredo['neutros'],	
						  ...
						  'RosalinaP' => $Rosalina['positivos'],
						  'RosalinaNe' => $Rosalina['negativos'],
						  'RosalinaN' => $Rosalina['neutros'],	
						  'JuanP' => $Juan['positivos'],
						  'JuanNe' => $Juan['negativos'],
						  'JuanN' => $Juan['neutros'],	
						  'MiguelP' => $Miguel['positivos'],
						  'MiguelNe' => $Miguel['negativos'],
						  'MiguelN' => $Miguel['neutros'],	
						  'ArmidaP' => $Armida['positivos'],
						  'ArmidaNe' => $Armida['negativos'],
						  'ArmidaN' => $Armida['neutros'],	
						  'SergioP' => $Sergio['positivos'],
						  'SergioNe' => $Sergio['negativos'],
						  'SergioN' => $Sergio['neutros'],	
						  'SantiagoP' => $Santiago['positivos'],
						  'SantiagoNe' => $Santiago['negativos'],
						  'SantiagoN' => $Santiago['neutros']							  						  						  
						  );
