...
<script>
  function dashboard(id, fData){
      ...
      function segColor(c){ return {Seguidores:"#807dba",Posts:"#41ab5d"}[c]; }
      
      // compute total for each candidato.
      fData.forEach(function(d){d.total = d.informacion.Seguidores+d.informacion.Posts;});
      ...
      // AQUI calculate total frequency by segment for all candidato.
      var tF = ['Seguidores','Posts'].map(function(d){ 
...
<!--Extraer Información en la Base de Datos-->

<script>
  var freqData=[
  {candidato:'Ignacio Peralta', informacion:{Seguidores:<?php echo $megustaci?>,Posts:<?php echo $seguidoresci ?>}},
  {candidato:'Jorge L. Preciado', informacion:{Seguidores:<?php echo $megustacj?>,Posts:<?php echo $seguidorescj ?>}},
  {candidato:'Martha Zepeda', informacion:{Seguidores:<?php echo $megustacm?>,Posts:<?php echo $seguidorescm ?>}},
  {candidato:'David Munro', informacion:{Seguidores:<?php echo $megustacd?>,Posts:<?php echo $seguidorescd ?>}},
  {candidato:'Leoncio Morán', informacion:{Seguidores:<?php echo $megustacl?>,Posts:<?php echo $seguidorescl ?>}},
  {candidato:'José Gallardo', informacion:{Seguidores:<?php echo $megustacf?>,Posts:<?php echo $seguidorescf ?>}},  
  {candidato:'Gerardo Galván', informacion:{Seguidores:<?php echo $megustacg?>,Posts:<?php echo $seguidorescg ?>}},
  {candidato:'Carlos Barbazán', informacion:{Seguidores:<?php echo $megustacc?>,Posts:<?php echo $seguidorescc ?>}}
  ];
