<script type="text/javascript">
  ...
  if (<?php echo $existe ?> ==2) {
    $('#alert').html('<div id="alert" class="alert fade in"><button type="button" class="close" data-dismiss="alert"></button><strong>Fecha No Encontrada!</strong> Se encuentra disponible a partir de la fecha: 4 Mayo 2015 hasta el <?php echo $fecha ?></div>');
  };
  </script>
